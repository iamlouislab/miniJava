...
public class SequenceType implements Type {
	...
	public boolean compatibleWith(Type _other) {
		...
		if (_other instanceof NamedType) {
			Logger.warning("NamedType.compatibleWith avant: " + otherType);
			otherType = ((NamedType) _other).getType();
			Logger.warning("NamedType.compatibleWith après: " + otherType);
		}
		if (otherType instanceof SequenceType) {
			Logger.warning("SequenceType.compatibleWith");
			...
			if (otherType instanceof ArrayType) {
				Logger.warning("ArrayType.compatibleWith");
				boolean _result = true;
